...
def set_ip(ifname, newip):
    ...
    ifreq = struct.pack('16sH2s4s8s', bytes(ifname, "utf-8"), AF_INET, b'\x00'*2, ipbytes, b'\x00'*8)
...
def set_netmask(ifname, netmask):
    ...
    ifreq = struct.pack('16sH2sI8s', bytes(ifname, "utf-8"), AF_INET, b'\x00'*2, nmbytes, b'\x00'*8) 
